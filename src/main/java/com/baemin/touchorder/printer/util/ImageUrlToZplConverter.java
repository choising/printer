 ...
 * @author seungmin
 */
public class ImageUrlToZplConverter {
    ...
    private String createBody(BufferedImage originalImage) throws IOException {
    ...
    private String headDoc(int x, int y) {
        return String.format("^FO%s,%s^GFA,%s,%s,%s,", x, y, total, total, widthBytes);
    }
